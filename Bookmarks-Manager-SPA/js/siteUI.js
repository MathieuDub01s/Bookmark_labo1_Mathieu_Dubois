...
async function renderBookmarks() {
    ...
    if (bookmarks !== null) {
        bookmarks.forEach(bookmark => {
            arrayCategory.push(bookmark.Category);
        ...
        updateDropDownMenu([...new Set(arrayCategory)]);
    ...
    if (bookmark !== null) {
        ...
        <div class="bookmarkdeleteForm">
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
              <div class="bookmarkContainerDelete">
                <img class="bookmarkUrl" src="http://www.google.com/s2/favicons?sz=50&domain=${bookmark.Url}">
...
function showIcon(){
    var inpuValue = document.getElementById("targetUrl").value;
    const imgIcon = document.getElementById("siteIconTarget");
    let imgIconsrc = "http://www.google.com/s2/favicons?sz=50&domain="+inpuValue;
    imgIcon.setAttribute("src", imgIconsrc);
    console.log(imgIconsrc);
    if(inpuValue == null || inpuValue == ""){
        imgIcon.setAttribute("src", "bookmark-star.svg");
    }
}
...
function renderBookmarkForm(bookmark = null) {
    ...
    if(bookmark.Url != null || bookmark.Url != "")
        changeIcon = `http://www.google.com/s2/favicons?sz=50&domain=${bookmark.Url}`;
    if(bookmark.Url == ""){
        changeIcon = "bookmark-star.svg"
    }
    $("#actionTitle").text(create ? "Création" : "Modification");
    $("#content").append(`
        <form class="form" id="bookmarkForm" name="createBookmarkForm">
           <img id="siteIconTarget" class="bookmarkUrlN" src="${changeIcon}">
           <br>
